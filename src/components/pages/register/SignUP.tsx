...
const SignUp = ({ open, handleClose }: SignUpProps) => {
  ...
  const handleSubmit = async () => {
    if (!agreed) {
      setFormValid("Please agree to the terms and conditions");
      return;
    }
    setSuccess(null);
      ...
      <Dialog open={open} onClose={handleClose} fullWidth>
        ...
        <DialogContent>
          <Stack spacing={2} margin={2}>
            ...
            <FormControlLabel
 control={<Checkbox checked={agreed} onChange={(e) => setAgreed(e.target.checked)} />}              label=" I agree to terms & conditions"
            />
            <Button
              sx={{
                bgcolor: "teal",
